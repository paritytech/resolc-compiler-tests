...
contract Test {
    ...
    uint8[KEY_SZ][KEY_SZ][KEY_SZ] KEY = [
        [[10, 33, 26, 15], [32, 62, 43, 58], [3, 8, 45, 23], [13, 55, 30, 21]],
        [[11, 22, 9, 2], [28, 52, 38, 27], [61, 53, 56, 37], [5, 25, 39, 59]],
        [[19, 36, 4, 48], [51, 0, 44, 35], [54, 46, 6, 60], [14, 31, 63, 29]],
        [[40, 7, 20, 50], [41, 12, 49, 16], [18, 17, 57, 34], [42, 24, 1, 47]]
    ];
    ...
    function encrypt(
        uint8[SIZE] memory data
    ) private view returns (uint8[SIZE] memory) {
    ...
    function complex(
        uint8[SIZE] memory message
    ) public view returns (uint8[SIZE] memory) {
