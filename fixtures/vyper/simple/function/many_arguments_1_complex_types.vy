...
#!           "method": "entry",
#!           "calldata": [],
#!           "caller": "0x2Da72206926e40a35A0153239aB80397b6051e58"
#!         }
#!       ],
#!       "expected": [
#!         "1"
...
def main(
    ...
    if param == 1:
        ...
        result = convert(p2[0].a.a, uint256)
    elif param == 5:
        result = p2[0].a.b[0]
    elif param == 6:
        result = p2[0].a.b[1]
        ...
        result = convert(p2[1].a.a, uint256)
    elif param == 10:
        result =p2[1].a.b[0]
    elif param == 11:
        result = p2[1].a.b[1]
        ...
        result = convert(p4[0].a, uint256)
    elif param == 16:
        result = p4[0].b[0]
    elif param == 17:
        result = p4[0].b[1]
    elif param == 18:
        result = convert(p4[1].a, uint256)
    elif param == 19:
        result = p4[1].b[0]
    elif param == 20:
        result = p4[1].b[1]
    elif param == 21:
        result = convert(p4[2].a, uint256)
    elif param == 22:
        result = p4[2].b[0]
    elif param == 23:
        result = p4[2].b[1]
    elif param == 24:
        result = convert(p5.a.a, uint256)
    elif param == 25:
        result = p5.a.b[0]
    elif param == 26:
        result = p5.a.b[1]
    elif param == 27:
        result = convert(p5.b, uint256)
    elif param == 28:
